...
export default function MottoCalender() {
  return (
    <div className='-bottom-36 xl:-bottom-20 left-1/2 z-30 absolute bg-white shadow px-8 py-10 border border-white rounded-2xl w-[90%] max-w-7xl -translate-x-1/2'>
      <div className='grid grid-cols-12 w-full'>
        ...
        <div className='flex justify-between items-center col-span-11 mt-5'>
          <div>
