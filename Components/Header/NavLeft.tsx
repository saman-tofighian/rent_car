...
export default function NavLeft() {
  return (
    <div className='flex justify-end xl:justify-center items-center order-3 xl:order-3 col-span-5 xl:col-span-2 h-full'>
      <Link
        href='/'
      ...
      >
        ...
        <LuLogIn className='xl:hidden block' size='1.3rem' />
      </Link>
    </div>
  );
}
