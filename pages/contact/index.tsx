    ...
    <section className='w-full'>
      ...
      <div className='my-12 px-[8%] w-full'>
        <div className='gap-y-9 lg:gap-y-0 grid grid-cols-12 bg-[#FFFFFF] px-[6%] py-8 border border-[#EDEDED] rounded-2xl w-full'>
          <div className='flex flex-col items-center lg:items-start col-span-12 lg:col-span-7 mt-8'>
            ...
            <p className='flex items-center mt-6 text-[#9A9A9A] text-[12px] lg:text-[16px]'>
          ...
          <div className='flex justify-center lg:justify-end col-span-12 lg:col-span-5'>
        ...
        <div className='gap-y-8 lg:gap-x-16 grid grid-cols-1 lg:grid-cols-12 bg-white mt-16 mb-20 px-6 lg:px-[6%] py-8 border border-[#EDEDED] rounded-2xl w-full'>
          {/* عنوان و فیلدها */}
          <div className='space-y-6 col-span-12 lg:col-span-6'>
            <div className='mt-2 text-center lg:text-right'>
              <h2 className='font-medium text-[#494949] text-xl lg:text-2xl'>
            ...
            <div className='relative'>
              <input
                ...
                className='peer block px-3 pt-5 pb-2 border border-gray-300 focus:border-gray-400 rounded-lg outline-none w-full text-gray-900 text-sm placeholder-transparent'
              />
              <label
                htmlFor='fullname'
                className='top-2 peer-focus:top-2 peer-placeholder-shown:top-1/2 right-3 absolute bg-white px-1 text-gray-400 peer-focus:text-gray-600 peer-placeholder-shown:text-gray-400 peer-focus:text-xs text-sm peer-placeholder-shown:text-sm transition-all peer-placeholder-shown:-translate-y-1/2'
              >
                نام و نام خانوادگی
              </label>
            </div>
          ...
          <div className='flex flex-col col-span-12 lg:col-span-6'>
            <div className='mt-0 lg:mt-16'>
              <textarea
                ...
                className='peer block px-3 pt-5 pb-2 border border-gray-300 focus:border-gray-400 rounded-lg outline-none w-full h-40 text-gray-900 text-sm resize-none placeholder-transparent'
              />
            </div>
